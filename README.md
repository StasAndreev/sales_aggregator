...
4. Метрики рассчитываются по запросу, т.к. для того, чтобы их рассчёт был оптимальным заранее, нужно соответствие критериям:
    - большая БД
    - редкое обновление данных о продажах
    - частые запросы на метрики
